...
{
    public class DAEventDetails : IBaseCrud<EventDetails>
    {
        ...
        public EventDetails Retrieve(int ID)
        {
            ...
            try
            {
                ...
                {
                    sqlConnection.Open();
                    using (SqlCommand sqlCommand = new SqlCommand("usp_EventDetails_Retrieve", sqlConnection))
                    {
                        sqlCommand.CommandType = CommandType.StoredProcedure;
                        ...
                        using (SqlDataReader dr = sqlCommand.ExecuteReader())
                        {
                            if (dr.HasRows)
                            {
                                if (dr.Read())
                                {
                                    obj.ID = int.Parse(dr["EventDetailsID"].ToString());
                                    ...
                                    obj.StartDate = DateTime.Parse(dr["Sales"].ToString());
                                    obj.EndDate = DateTime.Parse(dr["Sales"].ToString());
        ...
        {
            List<EventDetails> All = new List<EventDetails>();
            try
            {
                using (SqlConnection sqlConnection = new SqlConnection(Connection.ConnectionString))
                {
                    sqlConnection.Open();
                    using (SqlCommand sqlCommand = new SqlCommand("usp_EventDetails_RetrieveALL", sqlConnection))
                    {
                        sqlCommand.CommandType = CommandType.StoredProcedure;
                        using (SqlDataReader dr = sqlCommand.ExecuteReader())
                        {
        ...
        public void Update(EventDetails obj)
        {
            try
            {
                using (SqlConnection sqlConnection = new SqlConnection(Connection.ConnectionString))
                {
                    sqlConnection.Open();
                    using (SqlCommand sqlCommand = new SqlCommand("usp_EventDetails_Update", sqlConnection))
                    {
                        sqlCommand.CommandType = CommandType.StoredProcedure;
        ...
        public void Delete(int ID)
        {
            try
            {
                ...
                {
                    sqlConnection.Open();
                    using (SqlCommand sqlCommand = new SqlCommand("usp_EventDetails_Delete", sqlConnection))
                    {
                        sqlCommand.CommandType = CommandType.StoredProcedure;
                        sqlCommand.Parameters.AddWithValue("ID", ID);
                        sqlCommand.ExecuteNonQuery();
        ...
        public int Count()
        {
            ...
            try
            {
                ...
                {
                    sqlConnection.Open();
                    using (SqlCommand sqlCommand = new SqlCommand("usp_EventDetails_Count", sqlConnection))
                    {
                        sqlCommand.CommandType = CommandType.StoredProcedure;
