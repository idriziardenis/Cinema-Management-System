...
{
    public class DACategory : IBaseCrud<Category>
    {
        ...
        public Category Retrieve(int ID)
        {
            ...
            try
            {
                ...
                {
                    sqlConnection.Open();
                    using (SqlCommand sqlCommand = new SqlCommand("usp_Category_Retrieve", sqlConnection))
                    {
                        sqlCommand.CommandType = CommandType.StoredProcedure;
                        ...
                        using (SqlDataReader dr = sqlCommand.ExecuteReader())
                        {
                            if (dr.HasRows)
                            {
                                if (dr.Read())
                                {
                                    obj.ID = int.Parse(dr["CategoryID"].ToString());
        ...
        public List<Category> RetrieveALL()
        {
            ...
            try
            {
                ...
                {
                    sqlConnection.Open();
                    using (SqlCommand sqlCommand = new SqlCommand("usp_Category_RetrieveALL", sqlConnection))
                    {
                        sqlCommand.CommandType = CommandType.StoredProcedure;
                        using (SqlDataReader dr = sqlCommand.ExecuteReader())
                        {
        ...
        public void Update(Category obj)
        {
            try
            {
                ...
                {
                    sqlConnection.Open();
                    using (SqlCommand sqlCommand = new SqlCommand("usp_Category_Update", sqlConnection))
                    {
                        sqlCommand.CommandType = CommandType.StoredProcedure;
        ...
        public void Delete(int ID)
        {
            try
            {
                ...
                {
                    sqlConnection.Open();
                    using (SqlCommand sqlCommand = new SqlCommand("usp_Category_Delete", sqlConnection))
                    {
                        sqlCommand.CommandType = CommandType.StoredProcedure;
                        sqlCommand.Parameters.AddWithValue("ID", ID);
                        sqlCommand.ExecuteNonQuery();
        ...
        public int Count()
        {
            ...
            try
            {
                ...
                {
                    sqlConnection.Open();
                    using (SqlCommand sqlCommand = new SqlCommand("usp_Category_Count", sqlConnection))
                    {
                        sqlCommand.CommandType = CommandType.StoredProcedure;
